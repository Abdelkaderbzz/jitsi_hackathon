...
export default function LobbyParticipants() {
    ...
    const [drawerParticipant, closeDrawer, openDrawerForParticipant] =
        useParticipantDrawer();
        ...
        <>
            <div className={classes.headingContainer}>
                ...
                {participants.length > 1 && (
                    <div className={classes.link} onClick={admitAll}>
                        {t("lobby.admitAll")}
                    </div>
                )}
            </div>
            ...
            <JitsiPortal>
                ...
                >
                    <ul className={classes.drawerActions}>
                        ...
                        <li className={classes.drawerItem} onClick={admit}>
                            <Icon
                                className={classes.icon}
                                size={20}
                                src={IconCheck}
                        ...
                        <li className={classes.drawerItem} onClick={reject}>
                            <Icon
                                className={classes.icon}
                                size={20}
                                src={IconCloseLarge}
